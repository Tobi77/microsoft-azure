...
const GREETING_UTTERANCE = 'hallo';
const CANCEL_UTTERANCE = 'stop';
const HELP_UTTERANCE = 'hilfe';
...
class MessageRoutingBot {
    ...
    async onTurn(context) {
        ...
        if (context.activity.type === ActivityTypes.Message) {
                    ...
                    switch (dialogResult.status) {
                        case DialogTurnStatus.empty:
                            if (utterance === GREETING_UTTERANCE) {
                                ...
                                // to the user
                                await dc.context.sendActivity(`I didn't understand what you just said to me. Try saying 'Hallo', 'Hilfe' or 'Stop'.`);
                            }
                            break;
            ...
            await dc.context.sendActivity(`Welcome to the message routing bot! Try saying 'Hallo' to start talking, and use 'Hilfe' or 'Stop' at anytime to try interruption and cancellation.`);
        }
    }

    ...
    async onTurn(turnContext) {
        ...
        if (turnContext.activity.type === ActivityTypes.Message) {
            ...
            if (didBotWelcomedUser === false) {
                ...
                await turnContext.sendActivity(`Hallo ${userName}`);
                await turnContext.sendActivity(`Hallo ${turnContext.activity.from.name}`);
                ...
                switch (text) {
                    ...
                    case 'hey':
                    case 'hi':
                        await turnContext.sendActivity(`Dir auch "${ turnContext.activity.text }"`);
                        break;
                    case 'intro':
                    case 'help':
                        ...
                        break;
                    default :
                        await turnContext.sendActivity(`Strandard antwort, auf alles. 
                                                    This is a simple Welcome Bot sample. You can say 'intro' to

...
class SimplePromptBot {
    ...
    async askForName(dc) {
        await dc.prompt(NAME_PROMPT, `Wie heißt du?`);
    }
    ...
    async collectAndDisplayName(step) {
        ...
        await step.context.sendActivity(`Okay. Du bist ${ step.result }.`);
    ...
    async displayName(step) {
        ...
        await step.context.sendActivity(`Dein Name ist ${ userName }.`);
        await step.endDialog();
    }
